<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="articleList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="文章详情" align="center" prop="details" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px">
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="封面图图片" prop="url">
          <el-input v-model="form.url" placeholder="请输入封面图图片" />
        </el-form-item>
        <el-form-item label="文章类型：1沂蒙精神2其他">
          <el-select v-model="form.type" placeholder="请选择文章类型：1沂蒙精神2其他">
            <el-option
              v-for="dict in typeOptions"
              :key="dict.dictValue"
              :label="dict.dictLabel"
        ...
        <el-form-item label="文章详情" prop="details">
          <el-input v-model="form.details" placeholder="请输入文章详情" />
        </el-form-item>
      </el-form>
...
<script>
import { listArticle, getArticle, delArticle, addArticle, updateArticle, exportArticle } from "@/api/admin/article";
...
export default {
  data() {
    return {
      ...
      rules: {
        studentName: [
          { required: true, message: "文章类型：1沂蒙精神2其他不能为空", trigger: "blur" }
        ],        studentName: [
