 ...
 */
public class ChineseUpMoneyUtil {
    ...
    private static String getChineseInteger(int[] integers, boolean isWan) {
        ...
        Boolean isZheng = Boolean.FALSE;
        for (int i = 0; i < length; i++) {
            isZheng = Boolean.FALSE;
            String key = "";
            if (integers[i] == 0) {
                if ((length - i) == 13) {//万（亿）
                    key = IUNIT[4];
    ...
    public static void main(String[] args) {
        ...
        System.out.println(null + ": " +  ChineseUpMoneyUtil.toChinese(null));
    }
