...
public class MysqlGenerator {
    ...
    public static void main(String[] args) {
        ...
        String dbUrl = "jdbc:p6spy:mysql://192.168.99.100:3306/admin_framework?useUnicode=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai";
        String dbUserName = "docker_user";
        String dbPassword = "378541";
        ...
        String modubleName = "";
        String packageName = "com.zyk.api.service";
